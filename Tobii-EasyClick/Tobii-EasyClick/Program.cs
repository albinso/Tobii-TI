...
namespace Tobii_EasyClick
{
    class Program
    {
        public class SensorValueChangedEventArgs : ApplicationContext 
        {
            ...
            private static async void executeOnNotification(string UUID_Service, string UUID_Data, Windows.Foundation.TypedEventHandler<GattCharacteristic, GattValueChangedEventArgs> methodToExecute)
            {
