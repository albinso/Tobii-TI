...
//        void OnBatteryStatus(BLE_Utilities button, int battery);
...
//        void OnButtonClickOrHold(BLE_Utilities button, bool isClick, bool isHold);
//        /// <summary>
...
//        void OnButtonSingleOrDoubleClick(BLE_Utilities button, bool isSingleClick, bool isDoubleClick);
...
//        void OnButtonSingleOrDoubleClickOrHold(BLE_Utilities button, bool isSingleClick, bool isDoubleClick, bool isHold);
...
//        void OnButtonUpOrDown(BLE_Utilities button, bool isUp, bool isDown);
...
//        /// </summary>
//        /// <param name="button">The FlicButton that fired the event.</param>
//        void OnConnect(BLE_Utilities button);
...
//        void OnConnectionFailed(BLE_Utilities button, int status);
...
//        /// </summary>
//        /// <param name="button">The FlicButton that fired the event.</param>
//        void OnDisconnect(BLE_Utilities button);
...
//        void OnReadRemoteRssi(BLE_Utilities button, int rssi, int status);
//    }
//}
